...
For this class, we were asked to design a small scale wind turbine blade that would maximize power output while retaining structural stability. Because of the small scale, our turbine blades were designed to operate in low Reynolds number regimes. The design also had to adhere to several dimensional and operational constraints as listed below. 
